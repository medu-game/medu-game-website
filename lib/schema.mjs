...
const FAQ = [
  ...
  {
    nl: ['Hoe wordt de content gemaakt?', 'Cases worden samengesteld uit herbruikbare bouwblokken in het platform, samen met vakexperts en getoetst aan actuele richtlijnen. Zo is nieuwe content snel te bouwen en blijft kwaliteit geborgd.'],
  ...
  {
    nl: ['Integreert het met ons LMS?', 'Ja. Er zijn kant-en-klare koppelingen met de top-3 LMS-systemen voor voortgangsrapportage, plus single sign-on en gebruikersanalytics.'],
    en: ['Does it integrate with our LMS?', 'Yes. There are ready-made integrations with the top-3 LMS platforms for progress reporting, plus single sign-on and user analytics.'],
  },
  {
  ...
  {
    nl: ['Wat kost Medu.game?', 'De prijs hangt af van de modules, het aantal gebruikers en of je ons leerplatform of je eigen LMS gebruikt. Plan een demo, dan maken we een voorstel op maat voor jullie situatie.'],
    en: ['What does Medu.game cost?', "Pricing depends on the modules, the number of users and whether you use our learning platform or your own LMS. Book a demo and we'll put together a proposal tailored to your situation."],
  },
];
